package de.dbo.tools.util.print;

import static de.dbo.tools.util.print.Print.cpCardinality;
import static de.dbo.tools.util.print.Print.line;
import static de.dbo.tools.util.print.Print.lines;
import static de.dbo.tools.util.print.Print.linesNumbered;
import static de.dbo.tools.util.print.Print.linesSorted;
import static de.dbo.tools.util.print.Print.padLeft;
import static de.dbo.tools.util.print.Print.padRight;
import static de.dbo.tools.util.print.PrintConversions.toColllectionOfPrintables;
import static de.dbo.tools.util.print.PrintConversions.toMapOfPrintables;
import static de.dbo.tools.util.print.PrintConversions.toPrintable;

import de.dbo.tools.util.print.Print;
import de.dbo.tools.util.print.Printable;
import de.dbo.tools.util.print.PrintableMap;
import de.dbo.tools.util.print.PrintableObject;
