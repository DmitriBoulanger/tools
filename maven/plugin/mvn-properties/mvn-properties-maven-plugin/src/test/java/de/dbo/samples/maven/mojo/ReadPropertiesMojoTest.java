...
public class ReadPropertiesMojoTest extends AbstractMojoTestCase {
	...
	private static final String TEST_ARTIFACT_ID = "de.dbo.tools.maven.plugin:properties-test:jar:0.0.0-SNAPSHOT";
	private static final String TEST_MAVEN_PLUGIN = "maven-plugin";
	...
	private static StringBuilder print(final MavenProject mavenProject) {
		...
		sb.append("\n\t - Dependencies : " + printDependencis(mavenProject));
        return sb;
	}
	
	private static final StringBuilder printDependencis(final MavenProject mavenProject) {
